    ...
    <div>
      ...
      {step === 4 && (
        <div className="px-4 py-10 text-center">
          ...
          <h2 className="mb-2.5 text-2xl font-bold">You&apos;re live!</h2>
          <p className="mb-6 leading-7 text-muted">
            Your route is posted and visible to riders right now. Welcome to
            the Fudur partner family!
          </p>
          <div className="notice-box notice-green mb-6 text-left">
            <strong>What happens next:</strong>
            <br />
            1. Riders searching your route can find and book a seat
            <br />
            2. You&apos;ll see bookings and chat with riders from your
            dashboard
            <br />
            3. Get paid directly by your passengers when they board
          </div>
          <Button
            variant="green"
            full
